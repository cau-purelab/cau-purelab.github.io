...
export const CONTENT: LabContent = {
  ...
  keywords: ["AI Security", "Machine Unlearning", "Trustworthy AI", "Data Privacy"],
  news: [
    ...
    { id: 'n1', date: '2024.03.04', title: 'Security Visual Intelligence Lab (SVIL) founded by Prof. Seungmin Rho at Chung-Ang University.' },
  ],
  research: [
    {
      id: '1',
  ...
  members: [
    ...
    },
    {
      ...
      specialization: 'AI Watermarking Intern',
      links: { github: '#' }
    },
    {
      id: 'a1',
      ...
      role: 'Master',
      isAlumni: true,
      destination: 'Samsung Electronics (AI Research)',
